...
namespace Phrenapates.Services
{
    public class RaidService
    {
        ...
        public static long AIPhaseCheck(
            ...
            string bossName, Difficulty difficulty, List<long> bossCharacterId, 
            List<CharacterStatExcelT> characterStatExcels    
        )
        {
            var characterStat = characterStatExcels.FirstOrDefault(x => x.CharacterId == bossCharacterId[bossIndex]);
